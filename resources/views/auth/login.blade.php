...
@section('title', 'Masuk ke Akun Anda | PintarDigital')
    ...
    <section class="min-h-[calc(100vh-64px)] flex items-center justify-center py-12 px-8">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-10">
                <h1 class="text-3xl font-extrabold tracking-tight text-on-surface mb-2">Selamat Datang Kembali</h1>
                <p class="text-on-surface-variant">Lanjutkan perjalanan belajar coding Anda tanpa gangguan.</p>
            </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between items-center mb-2">
                            <label for="password"
                                class="block text-sm font-bold text-on-surface-variant uppercase tracking-widest">Kata Sandi</label>
                            <a href="#" class="text-xs font-bold text-primary hover:underline">Lupa?</a>
                        </div>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="remember" id="remember"
                            class="w-4 h-4 text-primary bg-surface-container-low border-none rounded focus:ring-primary/20">
                        <label for="remember" class="ml-2 text-sm font-medium text-on-surface-variant">Ingat saya di perangkat ini</label>
                    </div>
